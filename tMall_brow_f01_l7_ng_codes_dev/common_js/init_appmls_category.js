...
$append_mls.appendIni(
{
	...
	script : [
				...
				} ,
				{
					...
					"search-get-json" : document.baseURI + "assets/js/getJson-search.js" ,
					"category_tab" : document.baseURI + "assets/js/getJson-category_tab.js" ,
					"sinInv-search-get-json" : document.baseURI + "assets/js/getJson-detail_detail.js" ,
					"sinInv-detail-get-json" : document.baseURI + "assets/js/getJson-detail_detail.js" ,
